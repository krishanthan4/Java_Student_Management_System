...
public class student_attendence1 extends javax.swing.JFrame {
    ...
    private void TableLoad() {
        try {
            ...
            ResultSet classSet = MySQL.execute("SELECT * FROM `student_has_class`");
            ...
            while (classSet.next()) {
                ...
                vector.add(classSet.getString("student_has_class.Student_Attendence"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Class Id", "Attendence"
            }
        ) {
...
model.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(student_attendence1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new student_attendence1().setVisible(true);
            }
        });
    }
