...
public class Teacher_Enrollment extends javax.swing.JFrame {
    ...
    private void TableLoad() {
        try {
            ...
            while (teacherSet.next()) {
                teacherVector.add(teacherSet.getString("teacher.Tno"));
            ...
            while (classSet.next()) {
                ...
                classVector.add(classSet.getString("class.Classno"));
                Vector vector = new Vector();
                vector.add(classSet.getString("class.Teacher_Tno"));
                vector.add(classSet.getString("class.Classno"));
                vector.add(classSet.getString("class.teacher_attendence"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Teacher Enrollment");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher Id", "Class Id", "Attendence"
            }
        ) {
...
model.setRowCount(0);
        ...
        ResultSet resultset = MySQL.execute("UPDATE `student_has_class` SET `Student_Attendence`='" + attendence + "' WHERE `Class_Classno`='" + classid + "' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teacher_Enrollment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
